...
<div class="colorDot" data-color="#09FFCC" style="background:#09FFCC;"></div>
<div class="colorDot" data-color="#D4263E" style="background:#D4263E;"></div>
<div class="colorDot"  data-color="#00FFC9 - #8079AA " style="  background: linear-gradient(to right, #00FFC9 , #8079AA);"></div>
...
<div><p>Font secondaire:</p><h1>Lora</h1></div>
</div>
</div>
